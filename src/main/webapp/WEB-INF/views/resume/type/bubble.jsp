...
<div class="row">
	<div class="col-lg-8 col-md-10 col-sm-10 col-xs-10 col-lg-offset-2 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">        
		...
		<div id="proprobarbar" class="col-lg-5 col-md-6">
...
<div class="row" id="backSmoke" style="background:url('${pageContext.request.contextPath}/resources/images/resume/resumeBack.png');background-size:cover">
	...
	<div style="margin:10px 0 0 0">             
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-8 col-lg-offset-4 col-md-offset-5 col-sm-offset-4 col-xs-offset-2">                      
				...
				<c:if test="${fn:endsWith(resumeCommand.r_pname, '.jpg') ||                       
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"> 
						<img id="userFoto" class="resumeFoto" src="imageView.do?userId=${resumeCommand.m_id}">
					</div>
				</c:if>
				<c:if test="${empty resumeCommand.r_pname}">
					<img id="defaultFoto" class="resumeFoto" src="${pageContext.request.contextPath}/resources/images/resume/blank-profile.png">
				</c:if>
					<span style="background-color:black;">
						<span class="col-lg-9 col-md-9 col-sm-12 col-xs-12" style="margin:5px;"><b>작성일 : ${resumeCommand.r_date}</b></span>
				...
				<c:if test="${userGrade>=20&&userGrade<30}">
					<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
						<input type="text" id="emailCopy" value="${resumeCommand.m_id}" style="width:200px;text-align:center;" readonly> 
						<input type="button" class="btn btn-default" id="clipboard" onclick="copyClipboard()" value="이메일 복사" style="margin:5px;">                               
					</div>
					<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 col-md-offset-1 col-sm-offset-1 col-xs-offset-1" style="margin-top:5px;">
		...
		<div id="rG_resume" style="display:none;">
			...
			<div style="text-align:center"><span class="rG_sub" id="r_intro">자기 소개</span></div>
			<div class="rG_sub" <c:if test="${resumeCommand.r_intro ne null}">style="border:1px solid gray;border-radius:10px;"</c:if>>${resumeCommand.r_intro}</div>
		</div> 
		...
		<div id="rF_resume" style="display:none" class="">
			...
			<c:if test="${!empty resumeCommand.fname}">
				첨부파일 : <a href="file.do?userId=${resumeCommand.m_id}">${resumeCommand.fname}</a>
			</c:if>
		</div>                      
	</div>
