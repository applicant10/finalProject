...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/resume/enterRegiAddress.js"></script>
   	<div>                      
	   	<div class="col-lg-9 col-md-9 col-sm-10 col-xs-10 col-lg-offset-4 col-md-offset-2 col-sm-offset-2 col-xs-offset-2" style="padding:0 0 30px 0;">
	   		<h3 id="h3Title">기업 회원 가입(1/2)</h3>                   
	   		<div style="color:gray;">*기본양식을 기입해 주세요!</div>                                          
	   	</div>
	   	<p>                
   		<form:form commandName="enterpriseUserCommand" action="enterpriseReg.do" id="enterpriseRegisterForm">
   			<div id="firstForm">
   			<ul>
   				<li>
   					<label for="enterprise_num">사업자 번호 : </label>
   					<input type="text" class="others" id="enterprise_num" name="enterprise_num" value="${enterpriseUserCommand.enterprise_num}">
   					<div id="confirmEnterNum" style="text-align:center">입력해 주세요!</div>
   				</li>
   				<li style="margin:0 0 22px 0">
   					<label for="enterprise_name">기업명 : </label>
   					<input type="text" class="others" id="enterprise_name" name="enterprise_name" value="${enterpriseUserCommand.enterprise_name }">
   				</li>
   				<li style="margin:0 0 22px 0">
   					<label for="enterprise_ceo">대표자 명 : </label>
   					<input type="text" class="others" id="enterprise_ceo" name="enterprise_ceo" value="${enterpriseUserCommand.enterprise_ceo}">
   				</li>
   				<li>
   					<label for="enterprise_postCode">기업 우편 번호 : </label>
   					<input type="text" class="postCode" id="enterprise_postCode" name="enterprise_postCode" value="${enterpriseUserCommand.enterprise_postCode}" readOnly>
   					<input type="button" id="enterprise_postCode_search" value="주소 찾기">
   				</li>
   				<li>
   					<label for="enterprise_address">기업 주소 : </label>
   					<input type="text" class="others" id="enterprise_address" name="enterprise_address" value="${enterpriseUserCommand.enterprise_address}" readOnly>
   				</li>
   				<li style="margin:0 0 22px 0">	
   					<label for="enterprise_address_detail">기업 상세 주소</label>
   					<input type="text" class="others" id="enterprise_address_detail" name="enterprise_address_detail" value="${enterpriseUserCommand.enterprise_address_detail}" placeholder="상세주소를 입력해 주세요.">
   				</li>
   				<li style="margin:0 0 22px 0">
   					<label for="enterprise_phone_num">기업 전화 번호 : </label>
   					<input type="text" class="others" id="enterprise_phone_num" name="enterprise_phone_num" value="${enterpriseUserCommand.enterprise_phone_num}">
   				</li>
   				<li style="margin:0 0 22px 0">
   					<label for="enterprise_pax_num">기업 팩스 번호 : </label>
   					<input type="text" class="others" id="enterprise_pax_num" name="enterprise_pax_num" value="${enterpriseUserCommand.enterprise_pax_num}">
   				</li>
   				<li style="margin:0 0 22px 0">
   				...
   				<li style="margin:0 0 22px 0">
   					...
   					<input type="text" class="others" id="enterprise_info" name="enterprise_info" value="${enterpriseUserCommand.enterprise_info}">
   				</li>
   				<li>
   			...
   			<ul>
   				...
   				<li style="margin:0 0 22px 0">
   					...
   					<input type="text" class="others" id="m_nick" name="m_nick" value="${enterpriseUserCommand.m_nick}">
   				</li>
   				<li>
   				...
   				<li style="margin:0 0 22px 0">
   					...
   					<input type="text" class="others" id="enterprise_charge" name="enterprise_charge" value="${enterpriseUserCommand.enterprise_charge}">
   				</li>
   				<li style="margin:0 0 22px 0">
   					<label for="enterprise_charge_phone">담당자 연락처 : </label>
   					<input type="text" class="others" id="enterprise_charge_phone" name="enterprise_charge_phone" value="${enterpriseUserCommand.enterprise_charge_phone}">
   				</li>
   				<li>
   				...
   				<li>
   					<input type="button" value="Prev" class="prevButton">
   				</li>
   				<li>
